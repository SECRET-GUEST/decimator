...
#Function to delete files
    ...
    def GUI(self):
        ...
        self.setWindowIcon(QIcon(ressource_path("decimator.png")))
        ...
        #Widgets
        self.btn_select = QPushButton("Select a folder", self)
        self.btn_select.clicked.connect(self.select_folder)

        self.lab_selecter = QLabel("Selected folder: ", self)

        self.entry_name = QLineEdit(self)
        self.entry_name.setPlaceholderText("Enter the name of the file or folder")
        ...
        lay_decimator.addWidget(self.btn_select)
        lay_decimator.addWidget(self.lab_selecter)
